"""
Latest Edit: August 11, 2020

Team Kalinaw Website Main Program for Impact Hackathon

Install:
 - FLASK, Flask-Login,
 - SQL_ALCHEMY (sqlite -> best for compatibility issues)

Flask SQLAlchemy Doc: https://flask-sqlalchemy.palletsprojects.com/en/2.x/
...
# Connecting to www.website.com/about
@app.route("/about")
def about():
    """
    About Page
